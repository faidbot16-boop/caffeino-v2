          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-bg-card flex items-center justify-center text-text-secondary hover:text-[#1877F2] hover:bg-border transition-all"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-bg-card flex items-center justify-center text-text-secondary hover:text-[#E4405F] hover:bg-border transition-all"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-10 h-10 rounded-full bg-bg-card flex items-center justify-center text-text-secondary hover:text-[#25D366] hover:bg-border transition-all"
              >
